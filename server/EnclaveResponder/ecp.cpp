/*
 * ECP implementation for Server EnclaveResponder
 */
    ...
    sgx_ec_key_128bit_t* derived_key)
{
    ...
    sgx_ec_key_128bit_t key_app_derive_key;
    ...
    se_ret = sgx_rijndael128_cmac_msg((sgx_cmac_128bit_key_t *)cmac_key,
        ...
        (sgx_cmac_128bit_tag_t *)&key_app_derive_key);
    if (SGX_SUCCESS != se_ret)
    {
        memset(&key_app_derive_key, 0, sizeof(key_app_derive_key));
    ...
    *key_len = 0x0080;
    ...
    se_ret = sgx_rijndael128_cmac_msg((sgx_cmac_128bit_key_t *)&key_app_derive_key,
                                      p_derivation_buffer,
